...
A Programação Estocástica Multiestágio, descrita na Seção~\ref{sec:prog_estocastica}, é a abordagem natural para incorporar essa incerteza de forma explícita, representando a evolução do PLD e da geração por uma árvore de cenários e obtendo uma política de contratação adaptativa: a decisão de cada estágio é condicionada ao histórico de realizações observadas, não a um único cenário determinístico \cite{birge2011}.
