...
Em rela\c{c}\~ao a \citeonline{guerreiro2017}, que aborda a otimiza\c{c}\~ao est\'atica de carteiras com minimiza\c{c}\~ao de CVaR e gera\c{c}\~ao de cen\'arios via NEWAVE, sem formula\c{c}\~ao estoc\'astica multiestágio, este trabalho traz tr\^es acr\'escimos principais: (i) uma formula\c{c}\~ao din\^amica multiestágio, em que as decis\~oes sequenciais respeitam n\~ao antecipatividade e capturam a interdepend\^encia temporal entre contratos de diferentes meses; (ii) uma compara\c{c}\~ao emp\'irica entre DEQ e PDDE como abordagens de solu\c{c}\~ao para o mesmo problema, o que permite avaliar a escalabilidade de cada m\'etodo; e (iii) restri\c{c}\~oes expl\'icitas de fluxo de caixa e limite de cr\'edito, modelando a solv\^encia intra-horizonte da comercializadora.
